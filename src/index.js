...
io.on('connection',(socket)=>{
    ...
    socket.on('sendMessage',(message,callback)=>{
        ...
        if(filter.isProfane(message)){
            return callback('Abusive language is not allowed')
        }
...
//use socket to emit to single client
//use io to emit to every client
//use io.to to emit to every client in a specific room
//use socket.broadcast.to to emit to every client(excluding itself) in a specific room